...
<div class="registration-box">
        <div class="registration-content">
            <h2>Delete Casting</h2>
            <form:form action="${pageContext.request.contextPath}/casting/deleteCastingController" method="post" modelAttribute="casting">
    ...
    <select name="selectedActor2">
        ...
        <c:forEach items="${castList}" var="actor">
            <option value="${actor.castingId}">${actor.actor}</option>
                ...
                <button type="submit">Delete Casting</button>
            </form:form>
        </div>
    </div >
